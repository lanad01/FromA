...
<table>
	<tr height="40px"><td>상품명</td>
		<td><form:input path="item_name" cssClass="itemName" disabled="true"/></td></tr>
	...
	<tr height="40px"><td>파일</td>
		<td><img alt="" src="${pageContext.request.contextPath}/upload/${imageName }"  
			width="210" height="240"></td></tr> <!--  이미지이름은 ItemController에서 보내는 item -->
	<tr height="40px"><td>설명</td><td><form:textarea path="description" disabled="true"/></td></tr>
</table><br/><input type="submit" value="삭제"/><br/><br/>
