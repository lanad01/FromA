...
function check(form){
if(form.item_id.value==''){alert("번호를 입력하세요.");return false;}
if(form.item_name.value==''){alert("이름을 입력하세요.");return false;}
...
<table>
	<tr height="40px"><td>상품번호</td><td><form:input path="item_id"
		cssClass="itemId" maxLength="20"/></td>
		<td><font color="red"><form:errors path="item_id"/></font></td></tr>
	<tr height="40px"><td>상품명</td><td><form:input path="item_name"
